...
def load_model_and_data(dataset_name, device):
    ...
    model_path = f'saved_models/TransGATDTA_model_{dataset_name}.pth'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate TransGATDTA model and generated molecules.")
