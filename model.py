...
class Encoder(torch.nn.Module):
    def __init__(self, Drug_Features, dropout, Final_dim):
        ...
        self.hidden_dim = 376
        self.gat1 = GATConv(Drug_Features, Drug_Features * 2, heads=4)  # 4头注意力
        self.gat2 = GATConv(Drug_Features * 2 * 4, Drug_Features * 3)   # 注意维度变化
        self.gat3 = GATConv(Drug_Features * 3, Drug_Features * 4)
